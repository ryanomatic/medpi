...
void do_deletedoor(struct char_data *ch, char *argument, int cmd)
{
	...
	world[room]->dir_option[dir]->general_description = my_free(world[room]->dir_option[dir]->general_description);
	world[room]->dir_option[dir]->keyword = my_free(world[room]->dir_option[dir]->keyword);
	world[room]->dir_option[dir] = my_free(world[room]->dir_option[dir]);
